# Script for querying the ICD-10-PCS Tables vector index
...
# Example query
response = query_engine.query("Give me the ICD-10-PCS code for Measurement of Arterial Saturation, Peripheral, Percutaneous Approach")
print(response)